...
object Task1 : Task() {
   ...
   override fun runTask() {
      ...
      printlnDouble(Integrate.legendre2(-2.0, 2.0, Functions.makeHorner(Data.polyCoof)))
      ...
      println("Funkcja wielomianowa")
      printlnDouble(Integrate.legendre3(-2.0, 2.0, Functions.makeHorner(Data.polyCoof)))
      ...
      println("Funkcja wielomianowa")
      printlnDouble(Integrate.legendre4(-2.0, 2.0, Functions.makeHorner(Data.polyCoof)))
      ...
      println("Funkcja wielomianowa")
      printlnDouble(Integrate.legendre5(-2.0, 2.0, Functions.makeHorner(Data.polyCoof)))
   }
}